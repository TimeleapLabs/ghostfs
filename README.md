...
- Replace all occurrences of "GhostFS" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `GhostFS` means the name of the project, while `ghostfs` is used in file names.
  - Remember to rename the `include/ghostfs` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
